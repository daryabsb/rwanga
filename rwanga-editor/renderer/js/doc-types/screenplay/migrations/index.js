...
(function() {
  ...
  function _isV5(version) { return typeof version === 'string' && version.charAt(0) === '5'; }
  ...
  function migrate(parsed) {
    ...
    while (hops < MAX_HOPS) {
      ...
      if (_isV5(version)) return current;          // already at or beyond v5 (latest)
      ...
      if (_isV4(version) && steps.v4toV5) { current = steps.v4toV5(current); hops += 1; continue; }
